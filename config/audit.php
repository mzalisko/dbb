...
return [
    ...
    */
    ...
    'events' => [
        ...
        'deleted',
        'restored',
        'forceDeleted', // ContactEntry purge → entry.purged (PM-T01, critic N3)
    ],
    ...
    */
    ...
    // false → не зберігати порожні аудити: коли update зачепив лише виключені
    // поля ($auditExclude), old/new порожні → пропускаємо (без шуму).
    'empty_values' => false,
    ...
    */
    // Site.geo_tabs/geo_rules/data_categories та ContactEntry.countries — JSON-масиви.
    // Без true owen-it мовчки НЕ аудитив би зміни гео/категорій (ядро PM-T05 резолву).
    ...
    */
    ...
    // false у prod/dev — не аудитимо seed/artisan (PM-T01, critic S2).
    // true у тестах через phpunit env, бо PHPUnit працює в console-контексті.
