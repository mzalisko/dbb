...
<div x-data="{ show: @js($open) }"
    ...
    <div x-show="show"
         ...
         style="position:fixed; top:0; right:0; bottom:0; width:{{ $width }}px; max-width:100vw; background:var(--card); border-left:1px solid var(--ink-3); z-index:61; display:flex; flex-direction:column;"
         x-cloak>
